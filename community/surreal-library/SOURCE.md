...
prerequisites:
  commands: [uvx]
---
> Packaging change, 2026-09-13: this Apache-2.0 source is retained as reference material. Its original engine depends on imagemine, Claude/Anthropic, Gemini/Google, and optional Apple Photos integration. Photo Alchemy Studio routes generation through its root skill and built-in ImageGen. Do not execute the installer, API-key setup, Photos writes, launch agents, scheduling, or shell commands below as part of this module. The original integration is not bundled or enabled.
